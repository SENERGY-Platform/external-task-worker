...
func TestDefaultValue(t *testing.T) {
   ...
   "service_group_key":""
	...
	expected := `{"request":{"input":{"body":"true"}},"response":{"output":null},"task_info":{"worker_id":"workerid","task_id":"1","process_instance_id":"","process_definition_id":"","completion_strategy":"optimistic","time":"-62135596800","tenant_id":"user","business_key":""},"metadata":{"version":3,"device":{"id":"device_1","local_id":"d1u","name":"d1","attributes":null,"device_type_id":"dt1","owner_id":""},"service":{"id":"urn:infai:ses:service:494be526-d9df-459a-887d-b427ef6cc50e","local_id":"37-0-targetValue","name":"Set Device On","description":"","interaction":"request","protocol_id":"urn:infai:ses:protocol:f3a63aeb-187e-4dd9-9ef5-d97a6eb6292b","inputs":[{"id":"urn:infai:ses:content:b4449aba-7edd-43b5-9305-c71c8c701899","content_variable":{"id":"urn:infai:ses:content-variable:18ea8ab0-f59c-4214-baf2-f2caf299241a","name":"value","is_void":false,"omit_empty":false,"type":"https://schema.org/Boolean","sub_content_variables":null,"characteristic_id":"","value":true,"serialization_options":null,"function_id":"urn:infai:ses:controlling-function:79e7914b-f303-4a7d-90af-dee70db05fd9","aspect_id":"urn:infai:ses:aspect:861227f6-1523-46a7-b8ab-a4e76f0bdd32"},"serialization":"json","protocol_segment_id":"urn:infai:ses:protocol-segment:0d211842-cef8-41ec-ab6b-9dbc31bc3a65"}],"outputs":[],"attributes":[],"service_group_key":""},"protocol":{"id":"urn:infai:ses:protocol:f3a63aeb-187e-4dd9-9ef5-d97a6eb6292b","name":"protocol1","handler":"protocol1","protocol_segments":[{"id":"urn:infai:ses:protocol-segment:0d211842-cef8-41ec-ab6b-9dbc31bc3a65","name":"body"}],"constraints":null},"response_to":"response","error_to":"errors"}}`
	...
	if string(messageWithoutTrace) != expected {
		...
		t.Errorf("\n%#v\n%#v", string(messageWithoutTrace), expected)
	}
}
