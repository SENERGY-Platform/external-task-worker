...
func ExampleConfigurablesCommand1() {
	...
	//output:
	//{"request":{"input":{"body":"{\"color\":{\"blue\":170,\"green\":0,\"red\":255},\"duration\":3}"}},"response":{"output":null},"task_info":{"worker_id":"workerid","task_id":"1","process_instance_id":"","process_definition_id":"","completion_strategy":"optimistic","time":"-62135596800","tenant_id":"user"},"metadata":{"device":{"id":"device_1","local_id":"d1u","name":"d1","attributes":null,"device_type_id":"dt1"},"service":{"id":"service_1","local_id":"s1u","name":"s1","description":"","interaction":"","protocol_id":"p1","inputs":[{"id":"metrics","content_variable":{"id":"metrics","name":"metrics","is_void":false,"type":"https://schema.org/StructuredValue","sub_content_variables":[{"id":"color","name":"color","is_void":false,"type":"https://schema.org/StructuredValue","sub_content_variables":[{"id":"sr","name":"red","is_void":false,"type":"https://schema.org/Integer","sub_content_variables":null,"characteristic_id":"example_rgb.r","value":null,"serialization_options":null},{"id":"sg","name":"green","is_void":false,"type":"https://schema.org/Integer","sub_content_variables":null,"characteristic_id":"example_rgb.g","value":null,"serialization_options":null},{"id":"sb","name":"blue","is_void":false,"type":"https://schema.org/Integer","sub_content_variables":null,"characteristic_id":"example_rgb.b","value":null,"serialization_options":null}],"characteristic_id":"","value":null,"serialization_options":null},{"id":"duration","name":"duration","is_void":false,"type":"https://schema.org/Float","sub_content_variables":null,"characteristic_id":"urn:infai:ses:characteristic:9e1024da-3b60-4531-9f29-464addccb13c","value":null,"serialization_options":null}],"characteristic_id":"","value":null,"serialization_options":null},"serialization":"json","protocol_segment_id":"ms1"}],"outputs":null,"attributes":null,"service_group_key":""},"protocol":{"id":"p1","name":"protocol1","handler":"protocol1","protocol_segments":[{"id":"ms1","name":"body"}]},"input_characteristic":"example_hex","response_to":"response","error_to":"errors"}}
}
...
func ExampleConfigurablesCommand2() {
	...
	//output:
	//{"request":{"input":{"body":"{\"color\":{\"blue\":170,\"green\":0,\"red\":255},\"duration\":3}"}},"response":{"output":null},"task_info":{"worker_id":"workerid","task_id":"2","process_instance_id":"","process_definition_id":"","completion_strategy":"optimistic","time":"-62135596800","tenant_id":"user"},"metadata":{"device":{"id":"device_1","local_id":"d1u","name":"d1","attributes":null,"device_type_id":"dt1"},"service":{"id":"service_1","local_id":"s1u","name":"s1","description":"","interaction":"","protocol_id":"p1","inputs":[{"id":"metrics","content_variable":{"id":"metrics","name":"metrics","is_void":false,"type":"https://schema.org/StructuredValue","sub_content_variables":[{"id":"color","name":"color","is_void":false,"type":"https://schema.org/StructuredValue","sub_content_variables":[{"id":"sr","name":"red","is_void":false,"type":"https://schema.org/Integer","sub_content_variables":null,"characteristic_id":"example_rgb.r","value":null,"serialization_options":null},{"id":"sg","name":"green","is_void":false,"type":"https://schema.org/Integer","sub_content_variables":null,"characteristic_id":"example_rgb.g","value":null,"serialization_options":null},{"id":"sb","name":"blue","is_void":false,"type":"https://schema.org/Integer","sub_content_variables":null,"characteristic_id":"example_rgb.b","value":null,"serialization_options":null}],"characteristic_id":"","value":null,"serialization_options":null},{"id":"duration","name":"duration","is_void":false,"type":"https://schema.org/Float","sub_content_variables":null,"characteristic_id":"urn:infai:ses:characteristic:9e1024da-3b60-4531-9f29-464addccb13c","value":null,"serialization_options":null}],"characteristic_id":"","value":null,"serialization_options":null},"serialization":"json","protocol_segment_id":"ms1"}],"outputs":null,"attributes":null,"service_group_key":""},"protocol":{"id":"p1","name":"protocol1","handler":"protocol1","protocol_segments":[{"id":"ms1","name":"body"}]},"input_characteristic":"urn:infai:ses:characteristic:9e1024da-3b60-4531-9f29-464addccb13c","response_to":"response","error_to":"errors"}}
}
