...
func TestWorkerGroupCommand(t *testing.T) {
	...
	cmd1 := messages.Command{
		Version:       3,
		Function:      model.Function{RdfType: model.SES_ONTOLOGY_MEASURING_FUNCTION, Id: "urn:infai:ses:controlling-function:11ede745-afb3-41a6-98fc-6942d0e9cb33"},
		DeviceGroupId: "urn:infai:ses:device-group:be0e1dff-6325-4a1a-abbf-9e442c9cfdc2",
		DeviceClass:   &model.DeviceClass{Id: "urn:infai:ses:device-class:14e56881-16f9-4120-bb41-270a43070c86"},
		Input:         5641,
	}
	...
	for _, message := range protocolMessageStrings {
		...
		if !strings.Contains(msg.Request.Input["body"], `"kelvin":5641`) {
