...
const ConceptId = "urn:infai:ses:concept:58d23b4f-c315-4d7d-9230-fa989d55640a"
const ConceptName = "time"

func init() {
	base.Concepts[ConceptId] = base.GetConceptCastFunction(characteristicToConcept, conceptToCharacteristic)
	base.ConceptRepo.Register(model.Concept{Id: ConceptId, Name: ConceptName, BaseCharacteristicId: MilliSecondsId}, []model.Characteristic{
		{
			Id:   MilliSecondsId,
			Name: MilliSecondsName,
			Type: model.Float,
		},
		{
			Id:   SecondsId,
