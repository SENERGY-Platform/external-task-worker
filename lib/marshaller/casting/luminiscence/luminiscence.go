...
const ConceptId = "urn:infai:ses:concept:59b02acd-aac2-4415-976e-bd4790963ce4"
const ConceptName = "liminiscence"

func init() {
	base.Concepts[ConceptId] = base.GetConceptCastFunction(characteristicToConcept, conceptToCharacteristic)
	base.ConceptRepo.Register(model.Concept{Id: ConceptId, Name: ConceptName, BaseCharacteristicId: LuxId}, []model.Characteristic{
		{
			Id:   LuxId,
			Name: LuxName,
			Type: model.Float,
